...
\textbf{Free and Open Source Software in Education}
({\color{blue}http://fossee.in}) provides
free support on FOSS (Free and Open Source Software) to eliminate the
use of proprietary/commercial software systems in education across
India. The shift to FOSS packages will help educational institutions
monetarily. FOSS can be modified to suit different research and
academic needs. It can be used to train students to prepare them for
future career endeavours.  FOSS will also curb software piracy.
...
\textbf{Textbook Companion}: This activity provides reference
documentation by creating codes for solved examples of standard
textbooks using FOSS. It is available online for free download and
use. Students and faculty involved in Textbook Companion are given
honorarium and certificates for their efforts. Currently, we promote
this activity for Scilab, Python, Oscad, OpenFOAM and COIN-OR.
\end{minipage} \hspace{0.04\linewidth}
%second column
\begin{minipage}[t]{0.48\linewidth} 
\textbf{Lab Migration}: As long as a college uses proprietary tools as part of their lab
curriculum, we cannot eliminate the use of commercial software. The
Lab Migration activity aims to migrate college labs using proprietary
software to a FOSS only lab. We have Lab Migration for Scilab, Oscad,
OpenFOAM and COIN-OR.
\end{minipage}
...
\begin{minipage}[t]{0.48\linewidth} 
\begin{center}
    \includegraphics[width=1\linewidth]{images/self-wrkshop.jpg} 
...
Additionally, the FOSSEE team provides forum support,
({\color{blue}http://forums.spoken-tutorial.org/}) where the students
post queries, if any, post-workshop. The FOSSEE domain experts duly
...
with Python, is organized every year by FOSSEE since 2009. One of the
goals of the conference is to combine education, engineering, and
