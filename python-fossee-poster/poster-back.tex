...
Python.  These are available for learning, on the Spoken \mbox{Tutorial}
website, free of cost. You can access these tutorials from this
link: \\ {\color{blue}{\fontfamily{lmss}\selectfont
python.fossee.in/spoken-tutorials}}} \par
...
\item \justifying{{\bf{Textbook Companion Internship}} - Learn Python
  ...
  Internship. It aims to create Companions by coding solved \mbox{examples}
  from Standard textbooks, using Python. \mbox{Participate} and earn
  attractive honorarium and Certificate of Internship from FOSSEE, IIT
  \mbox{Bombay}!  For more details, please visit: \\
...
\item {{\bf{SELF Workshops}} - The Spoken Tutorial Team conducts
  workshops on Python.  These are \mbox{completely} free of cost, and are
